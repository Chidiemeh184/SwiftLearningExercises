...
//              This is a refactored version of the original
//=============================================================
...
////FUNCTION TO POPULATE A SET USING DATA FROM ARRAY WITH INDEXES (AN ARRAY)
////TODO
////NEEDS TO RETURN 
//func populateSet(var set: Set<String>, usingArray:[String], withValues: [Int]) -> (Set<String>) {
//    for numbers in withValues {
//        let name = usingArray[numbers]
//        set.insert(name)
//    }
//    return set
//}
//
//populateSet(mathStudents, usingArray: listOfAllStudents, withValues: [0,1,14,3,11,5,8])
//populateSet(scienceStudents, usingArray: listOfAllStudents, withValues: [7,8,9,13,1,12,3])
//
//print(mathStudents)
